...
-  An optimal, IDA*-based engine designed to solve the Rubik’s Cube.
- Optimized State Representation: Compressed cube states into a 64-bit Bitboard model, enabling O(1) memory lookups and fast bitwise move execution.
